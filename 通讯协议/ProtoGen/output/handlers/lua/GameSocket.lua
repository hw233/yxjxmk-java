...
function Pomelo.GameSocket.onInspireSingleChangePush(cb)
	Socket.On("area.guildBossPush.onInspireSingleChangePush", function(res) 
		Pomelo.GameSocket.lastOnInspireSingleChangePush = res
		cb(nil,res) 
...
function Pomelo.GameSocket.onInspireGuildChangePush(cb)
	Socket.On("area.guildBossPush.onInspireGuildChangePush", function(res) 
		Pomelo.GameSocket.lastOnInspireGuildChangePush = res
		cb(nil,res) 
...
function Pomelo.GameSocket.onGuildBossOverPush(cb)
	Socket.On("area.guildBossPush.onGuildBossOverPush", function(res) 
		Pomelo.GameSocket.lastOnGuildBossOverPush = res
		cb(nil,res) 
