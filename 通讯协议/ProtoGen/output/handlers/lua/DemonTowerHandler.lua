...
function Pomelo.DemonTowerHandler.getDemonTowerInfoRequest(cb,option)
	local input = nil
	Socket.OnRequestStart("area.demonTowerHandler.getDemonTowerInfoRequest", option)
	Socket.Request("area.demonTowerHandler.getDemonTowerInfoRequest", input, function(res)
...
function Pomelo.DemonTowerHandler.startDemonTowerRequest(cb,option)
	local input = nil
	Socket.OnRequestStart("area.demonTowerHandler.startDemonTowerRequest", option)
	Socket.Request("area.demonTowerHandler.startDemonTowerRequest", input, function(res)
		if(res.s2c_code == 200) then
